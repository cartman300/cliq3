...
qboolean trap_InPVS( const vec3_t p1, const vec3_t p2 ) {
	return toqbool(syscall( G_IN_PVS, p1, p2 ));
}

qboolean trap_InPVSIgnorePortals( const vec3_t p1, const vec3_t p2 ) {
	return toqbool(syscall( G_IN_PVS_IGNORE_PORTALS, p1, p2 ));
}
...
qboolean trap_AreasConnected( int area1, int area2 ) {
	return toqbool(syscall( G_AREAS_CONNECTED, area1, area2 ));
}
...
qboolean trap_EntityContact( const vec3_t mins, const vec3_t maxs, const gentity_t *ent ) {
	return toqbool(syscall( G_ENTITY_CONTACT, mins, maxs, ent ));
}

qboolean trap_EntityContactCapsule( const vec3_t mins, const vec3_t maxs, const gentity_t *ent ) {
	return toqbool(syscall( G_ENTITY_CONTACTCAPSULE, mins, maxs, ent ));
}
...
qboolean trap_GetEntityToken( char *buffer, int bufferSize ) {
	return toqbool(syscall( G_GET_ENTITY_TOKEN, buffer, bufferSize ));
}
