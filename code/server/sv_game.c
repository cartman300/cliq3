...
intptr_t SV_GameSystemCalls( intptr_t *args ) {
	...
	case G_ENTITY_CONTACT:
		return SV_EntityContact( (vec_t*)VMA(1), (vec_t*)VMA(2), (sharedEntity_t*)VMA(3), /*int capsule*/ qfalse );
	case G_ENTITY_CONTACTCAPSULE:
		return SV_EntityContact( (vec_t*)VMA(1), (vec_t*)VMA(2), (sharedEntity_t*)VMA(3), /*int capsule*/ qtrue );
	case G_TRACE:
